        ...
        <footer className="border-t border-border/60 bg-card">
            <Container className="py-10">
                <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-12">
                    {/* ---- Logo + Description ---- */}
                    <div className="flex flex-col items-center sm:items-start gap-3 max-w-lg col-span-5">
                        <Link
                            to="/"
                        ...
                        <p className="text-sm text-text-secondary text-center sm:text-left leading-relaxed">
                    ...
                    {FOOTER_COLUMNS.map((column: FooterColumn) => (
                        <div key={column.title} className="flex flex-col items-center sm:items-start gap-4 col-span-2">
